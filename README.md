...
* Learned about how to work on projects with virtual environments and used the codes below to run the project with venv
...
* Writed codes in monitoring_testing.py file and imported  to main.py file (in src file)
